...
bool Team::generateSpirit(int timestamp,int spirit)
{
    ...
    case 0: 
        if(live>=Dragon::maxlive){
            live-=Dragon::maxlive;
            tempSpirit=Dragon(spirits.size()+1,this,live/Dragon::maxlive);
            spirit_map[0]++;
        }
        break;
    case 1:
        if(live>=Ninja::maxlive){
            live-=Ninja::maxlive;
            tempSpirit=Ninja(spirits.size()+1,this);
            spirit_map[1]++;
        }
        break;
    case 2:
        if(live>=Iceman::maxlive){
            live-=Iceman::maxlive;
            tempSpirit=Iceman(spirits.size()+1,this);
            spirit_map[2]++;
        }
        break;
    case 3:
        if(live>=Lion::maxlive){
            live-=Lion::maxlive;
            tempSpirit=Lion(spirits.size()+1,this,live);
            spirit_map[3]++;
        }
        break;
    case 4:
        if(live>=Wolf::maxlive){
            live-=Wolf::maxlive;
            tempSpirit=Wolf(spirits.size()+1,this);
            spirit_map[4]++;
        }
        break;
