...
bool Team::generateSpirit(int timestamp,int spirit)
{
    ...
    case 0: 
        if(live>=Dragon::maxlive){
            live-=Dragon::maxlive;
            tempSpirit=*(new Dragon(spirit_map[0]+1,team_id));
            spirit_map[0]++;
        }
        break;
    case 1:
        if(live>=Ninja::maxlive){
            live-=Ninja::maxlive;
            tempSpirit=*(new Ninja(spirit_map[1]+1,team_id));
            spirit_map[1]++;
        }
        break;
    case 2:
        if(live>=Iceman::maxlive){
            live-=Iceman::maxlive;
            tempSpirit=*(new Iceman(spirit_map[2]+1,team_id));
            spirit_map[2]++;
        }
        break;
    case 3:
        if(live>=Lion::maxlive){
            live-=Lion::maxlive;
            tempSpirit=*(new Lion(spirit_map[3]+1,team_id));
            spirit_map[3]++;
        }
        break;
    case 4:
        if(live>=Wolf::maxlive){
            live-=Wolf::maxlive;
            tempSpirit=*(new Wolf(spirit_map[4]+1,team_id));
            spirit_map[4]++;
        }
        break;
    ...
    cout<<name<<' '<<tempSpirit.name<<' '<<spirits.size()<<' '<<"born with strength "<<tempSpirit.maxlive<<',';
